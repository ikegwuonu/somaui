...
const lineClasses = {
  base: "somaui-step-line absolute w-full group-last:hidden block h-px",
  top: {
    noDot: {
      sm: "top-[22px]",
      md: "top-6",
...
export function Step({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "somaui-step-container",
          "mt-0.5 ml-3 flex flex-1 flex-col",
          contentClassName
        )}
      >
        <span className="somaui-step-title flex items-center justify-center group-last:inline-block">
          <h2
            className={cn(
              "somaui-step-title",
