...
export function Textarea({
  ...
  return (
    <div className={cn('somaui-textarea-root', 'flex flex-col', className)}>
      <label className="block">
        {label ? (
          <span
            className={cn(
              'somaui-textarea-label',
              'block',
      ...
      {error ? (
        <FieldErrorText
          size={size}
          error={error}
          className={cn('somaui-textarea-error-text', errorClassName)}
        />
      ) : null}
    </div>
  );
