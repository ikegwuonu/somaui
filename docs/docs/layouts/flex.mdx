...
import { Flex } from '@somaui/ui/flex';
...
<Paper>
  <Flex justify="center" align="center">
    <Box className="border-muted flex size-24 items-center justify-center rounded-md border text-3xl font-semibold shadow">
      1
    </Box>
    <Box className="border-muted flex size-24 items-center justify-center rounded-md border text-3xl font-semibold shadow">
      2
...
<Paper>
  <Flex justify="start">
    ...
    <Box className="border-muted ms-auto flex size-24 items-center justify-center rounded-md border text-3xl font-semibold shadow">
      3
    </Box>
  </Flex>
</Paper>
...
<Paper>
  <Flex justify="center" align="center">
    <Box className="border-muted flex size-16 items-center justify-center rounded-md border text-3xl font-semibold shadow">
      1
    </Box>
    <Box className="border-muted flex size-20 items-center justify-center rounded-md border text-3xl font-semibold shadow">
      2
    </Box>
    <Box className="border-muted flex size-24 items-center justify-center rounded-md border text-3xl font-semibold shadow">
      3
