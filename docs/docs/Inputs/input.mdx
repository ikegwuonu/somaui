...
<Paper className="block">
  <div className="grid grid-cols-1 gap-4 text-gray-950 sm:grid-cols-2 2xl:grid-cols-4">
...
<Paper className="grid grid-cols-1 gap-4 text-gray-950 sm:grid-cols-2 2xl:grid-cols-3">
...
<Paper className="items-start justify-start gap-4 text-gray-950">
  <Input
    type="email"
    size="sm"
    label="Small"
