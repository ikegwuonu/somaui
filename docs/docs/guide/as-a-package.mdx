...
<Tabs groupId="package-manager">
  ...
  >
    <CodeBlock language="js">
      {`npm i @somaui/ui @headlessui/react @floating-ui/react tailwind-variants tailwind-merge`}
    </CodeBlock>
  </TabItem>
  <TabItem
    value="yarn"
  ...
  >
    <CodeBlock language="js">
      {`yarn add @somaui/ui @headlessui/react @floating-ui/react tailwind-variants tailwind-merge`}
    </CodeBlock>
  </TabItem>
  <TabItem
    value="pnpm"
  ...
  >
    <CodeBlock language="js">
      {`pnpm add @somaui/ui @headlessui/react @floating-ui/react tailwind-variants tailwind-merge`}
    </CodeBlock>
  </TabItem>
  <TabItem
    value="bun"
  ...
  >
    <CodeBlock language="js">
      {`bun add @somaui/ui @headlessui/react @floating-ui/react tailwind-variants tailwind-merge`}
    </CodeBlock>
  </TabItem>
</Tabs>

<div className="!mt-6 !mb-8 rounded-lg border border-blue-200 bg-blue-50 p-4 dark:border-blue-800 dark:bg-blue-950/30">
  **Package Overview** - **`somaui`** - The core UI component library -
...
/* Configure content sources for SomaUI components */
...
<div className="!mt-6 !mb-8 rounded-lg border border-purple-200 bg-purple-50 p-4 dark:border-purple-800 dark:bg-purple-950/30">
...
Now you're ready to start using SomaUI components in your application. For dark mode support, refer to our [dark mode guide](/docs/guide/dark-mode).
...
const CustomButton = ({ className, variant = 'primary', ...props }) => (
  <Button
    {...props}
    className={cn(
      'bg-gradient-to-r text-white shadow-lg transition-all hover:shadow-xl',
      variant === 'primary'
...
Now that you have SomaUI set up, explore these resources to enhance your application:
...
- Open an issue on [GitHub](https://github.com/ikegwuonu/somaui/issues)
- Check our [documentation](https://somaui.vercel.app/docs/guide/getting-started/docs) for detailed guides
