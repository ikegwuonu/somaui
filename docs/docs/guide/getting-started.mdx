...
Welcome to **SomaUI** - A modern, minimal React UI library built with **Tailwind CSS v4** and **React 19**. Get production-ready components that are intuitive, accessible, and performant.
...
<Tabs groupId="package-manager">
  ...
  >
    <CodeBlock language="js">
      {`npm i somaui @headlessui/react @floating-ui/react tailwind-variants tailwind-merge`}
    </CodeBlock>
  </TabItem>
  <TabItem
    value="yarn"
  ...
  >
    <CodeBlock language="js">
      {`yarn add somaui @headlessui/react @floating-ui/react tailwind-variants tailwind-merge`}
    </CodeBlock>
  </TabItem>
  <TabItem
    value="pnpm"
  ...
  >
    <CodeBlock language="js">
      {`pnpm add somaui @headlessui/react @floating-ui/react tailwind-variants tailwind-merge`}
    </CodeBlock>
  </TabItem>
  <TabItem
    value="bun"
  ...
  >
    <CodeBlock language="js">
      {`bun add somaui @headlessui/react @floating-ui/react tailwind-variants tailwind-merge`}
    </CodeBlock>
  </TabItem>
</Tabs>
