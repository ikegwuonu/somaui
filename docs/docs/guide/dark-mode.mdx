...
import { DropdownMenu } from "@somaui/ui/dropdown";
...
SomaUI 2.0 uses <strong>Tailwind CSS v4</strong> with the modern OKLCH color space for better color perception. Create or update your <code>app/globals.css</code>:
