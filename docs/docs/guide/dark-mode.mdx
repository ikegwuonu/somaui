...
Adding dark mode to your Next.js app, it's a one-time process. We use [next-themes](https://www.npmjs.com/package/next-themes) and [CSS variables](#configure-globalcss) for a seamless dark mode experience.
...
// import  import { DropdownMenu } from "@somaui/ui/dropdown"; when using ui package
...
<div className="mb-4 flex items-center gap-2">
  ...
  <span>
    Configure <strong>global.css</strong>
  </span>
</div>

### Configure global.css

SomaUI uses <strong>Tailwind CSS v4</strong> with the modern OKLCH color space for better color perception. Create or update your <code>app/styles/global.css</code>:

```css title=global.css
/* Import Tailwind CSS v4 */
@import 'tailwindcss';

/* Configure content sources for SomaUI components by uncommenting the line below if using the ui package */
