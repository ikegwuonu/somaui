...
<Paper className="flex-row flex-wrap justify-evenly gap-10">
...
<Paper className="flex-row flex-wrap justify-evenly gap-10">
  <RadialProgressBar value={70} size={120} progressbarWidth={5} />
</Paper>
...
<Paper className="flex-row flex-wrap justify-evenly gap-10">
  <div className="relative">
    <RadialProgressBar value={70} size={120} startAngle={45} />
