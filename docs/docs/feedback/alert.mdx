...
<Paper className="text-gray-950">
  <Alert
    color="info"
    icon={<EnvelopeIcon className="text-blue-dark w-6" />}
    clearIcon={<TrashIcon className="text-blue-dark w-6" />}
  >
...
import { Alert, Button } from 'somaui';
