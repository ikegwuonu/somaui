...
A flexible and intuitive rating component for collecting user feedback through visual ratings. Built on top of **rc-rate**, the Rate component seamlessly integrates with SomaUI's design system, providing a consistent and accessible way to gather user opinions and ratings.
...
<Paper className="items-start gap-4">
