...
A highly customizable phone input component with automatic formatting and international country code support. Built on top of **react-phone-input-2**, the PhoneNumber component seamlessly integrates with SomaUI's design system, providing a consistent and accessible user experience.
