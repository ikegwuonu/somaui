...
A flexible and intuitive slider component for selecting values from a range. Built on top of **rc-slider**, the RangeSlider component seamlessly integrates with SomaUI's design system, providing a consistent and accessible way to capture numeric input through visual interaction.
