...
A flexible and customizable pagination component for navigating through large datasets. Built on top of **rc-pagination**, the Pagination component seamlessly integrates with SomaUI's design system, providing a consistent and accessible user experience for paginated content.
