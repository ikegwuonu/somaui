...
A powerful, flexible table component built on top of **rc-table**. Seamlessly integrated with SomaUI's design system, this component provides a comprehensive solution for building data tables with sorting, filtering, and multiple visual variants.
...
- 📊 **Flexible Styling** - Customizable with SomaUI theme variables
...
```tsx
import { Empty } from "@somaui/ui/empty";
...
- **Theme consistency** - Use SomaUI theme variables for consistent styling
