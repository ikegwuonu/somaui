...
A powerful, headless table component built on top of **TanStack Table** (formerly React Table). Seamlessly integrated with SomaUI's design system, this component provides a flexible and performant solution for building complex, interactive data tables with sorting, filtering, pagination, and row selection.
...
export default function MainTable({ table }: TablePropsTypes) {
  ...
  return (
    <div className="custom-scrollbar w-full overflow-x-auto overflow-y-hidden">
      ...
      >
        <Table.Header className="!border-y-0 !bg-[var(--muted)]">
...
```tsx
import { ActionIcon } from '@somaui/ui/action-icon';
import { Select, SelectOption } from '@somaui/ui/select';
import { Text } from '@somaui/ui/typography';
...
import { Avatar, AvatarProps } from '@somaui/ui/avatar';
import { Badge } from '@somaui/ui/badge';
import { Text } from '@somaui/ui/typography';
...
- **Theme consistency** - Use SomaUI theme colors for consistent styling
