...
<Paper>
  <div className="mb-10 flex w-full flex-wrap items-center justify-around gap-3">
    <Badge>Badge</Badge>
  ...
  <div className="flex w-full flex-wrap items-center justify-around gap-3">
    <div className="relative inline-flex">
      ...
      <Badge
        size="sm"
        enableOutlineRing
        className="absolute top-0 right-0 translate-x-1/2 -translate-y-1/3"
      >
        99
      </Badge>
    </div>
...
```tsx
import { Badge, Avatar } from 'somaui';
