...
export function Checkbox({
  ...
  return (
    <div className={cn("somaui-checkbox-root", "flex flex-col", className)}>
      <label
        className={cn(
          "somaui-checkbox-container",
      ...
      {error ? (
        <FieldErrorText
          size={size}
          error={error}
          className={cn("somaui-checkbox-error-text", errorClassName)}
        />
      ) : null}
    </div>
  );
