...
import { ourPlacementObject } from "../select/select-shared.lib";
import { labelStyles } from "@/lib/label-size";
import type { ExtractProps } from "@/lib/extract-props";
declare const multiSelect: import("tailwind-variants").TVReturnType<{
    variant: {
        text: string;
        outline: string;
    };
...
export type MultiSelectProps<MultiSelectOption> = ExtractProps<typeof Listbox> & {
